...
export const homeFaqs: FaqsType[] = [
  {
    question:
  ...
  {
    question: 'Os flashcards realmente ajudam a melhorar o vocabulário?',
    response:
  ...
  {
    question: 'Vou conseguir aprender gramática usando o Flashvibe?',
    response:
  ...
  {
    question: 'É possível compartilhar meus decks com alguém?',
    response:
